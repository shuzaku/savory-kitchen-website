...
export function MenuHighlights() {
  ...
  return (
    <section id="menu" className="py-32 relative overflow-hidden bg-gradient-to-b from-white to-secondary/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-16 relative">
          ...
          >
            Click on a category to explore our soul food favorites
          </motion.p>
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {selectedCategory.featured && (
              <div className="mb-12">
                <h3 className="text-3xl mb-8 text-center">Featured {selectedCategory.title}</h3>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-border/50">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl">Complete {selectedCategory.title} List</h3>
                <motion.button
        ...
        >
          <div className="inline-block bg-white/80 backdrop-blur-sm border-2 border-primary/30 rounded-2xl px-8 py-6 max-w-2xl shadow-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Don't see what you're looking for? We're happy to customize any dish or create something special for your event.
            </p>
          </div>
        </motion.div>
      </div>
